...
class IO extends MBeanRegistrationSupport implements IOMBean {
	...
	private final TimedReading _numBytesWrittenPerSec = TimedReading.newPerSecond();
	
	private final TimedReading _numReadsPerSec = TimedReading.newPerSecond();
	
	private final TimedReading _numWritesPerSec = TimedReading.newPerSecond();
	
	private final TimedReading _numSyncsPerSec = TimedReading.newPerSecond();
