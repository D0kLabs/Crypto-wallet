...
package com.EDU.purdue.cs.bloat.editor;
...
public class SerialVersionUID {
	 ...
	 * <code>ClassEditor</code> implements {@link Serializable
	 * Serializable}. It checks superclasses.
	 */
	public static boolean implementsSerializable(final ClassEditor ce) {
		if (ce.type().equals(java.lang.reflect.Type.OBJECT)) {
			// Stop the recursion!
			return (false);
		}

		final java.lang.reflect.Type serializable = java.lang.reflect.Type.getType("Ljava/io/Serializable;");
		final java.lang.reflect.Type[] interfaces = ce.interfaces();
		...
		final java.lang.reflect.Type superclass = ce.superclass();
	 ...
	 * 
	 * @param ce
	 *            The class must implement {@link Serializable
	 *            Serializable}
	 */
