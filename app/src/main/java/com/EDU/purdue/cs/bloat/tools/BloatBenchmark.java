...
package com.EDU.purdue.cs.bloat.tools;

import com.EDU.purdue.cs.bloat.benchmark.Times;
import com.EDU.purdue.cs.bloat.cfg.FlowGraph;
import com.EDU.purdue.cs.bloat.codegen.CodeGenerator;
import com.EDU.purdue.cs.bloat.codegen.Liveness;
import com.EDU.purdue.cs.bloat.context.BloatContext;
import com.EDU.purdue.cs.bloat.context.CachingBloatContext;
import com.EDU.purdue.cs.bloat.context.PersistentBloatContext;
...
import com.EDU.purdue.cs.bloat.inline.CallGraph;
import com.EDU.purdue.cs.bloat.inline.Inline;
import com.EDU.purdue.cs.bloat.inline.InlineStats;
import com.EDU.purdue.cs.bloat.inline.Specialize;
import com.EDU.purdue.cs.bloat.optimize.Main;
import com.EDU.purdue.cs.bloat.reflect.MethodInfo;
import com.EDU.purdue.cs.bloat.trans.Peephole;
import com.EDU.purdue.cs.bloat.tree.Tree;
import com.EDU.purdue.cs.bloat.util.Assert;
...
import com.EDU.purdue.cs.bloat.benchmark.*;
import com.EDU.purdue.cs.bloat.cfg.*;
import com.EDU.purdue.cs.bloat.codegen.*;
import com.EDU.purdue.cs.bloat.context.*;
import com.EDU.purdue.cs.bloat.editor.*;
import com.EDU.purdue.cs.bloat.file.*;
import com.EDU.purdue.cs.bloat.inline.*;
import com.EDU.purdue.cs.bloat.optimize.*;
import com.EDU.purdue.cs.bloat.reflect.*;
import com.EDU.purdue.cs.bloat.trans.*;
import com.EDU.purdue.cs.bloat.tree.*;
import com.EDU.purdue.cs.bloat.util.*;
...
public class BloatBenchmark {
	...
	private static void intraBloat(final Collection liveMethods,
		...
		for (int count = 0; iter.hasNext(); count++) {
			...
			try {
				com.EDU.purdue.cs.bloat.optimize.Main.TRACE = BloatBenchmark.TRACE;
				if (!BloatBenchmark.VERIFY) {
					com.EDU.purdue.cs.bloat.optimize.Main.VERIFY = false;
				}
				com.EDU.purdue.cs.bloat.optimize.Main.bloatMethod(live, context);
